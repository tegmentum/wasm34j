...
public interface WebAssemblyMemory {
    ...
    /**
     * @return a {@link ByteBuffer} view over the live linear memory; the buffer is only valid while
     *     the owning instance is open and the memory has not been resized
     */
